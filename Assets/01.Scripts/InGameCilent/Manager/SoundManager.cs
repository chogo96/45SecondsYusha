...
//    [Header("BGM")]
//    public Dictionary<string, AudioClip> bgmClips;  // BGM 클립을 관리할 사전
...
//    public enum Sfx { CardUse, DeckShuffle, EnemyDead, ButtonActivate }
...
//    {
//        if (bgmClips.ContainsKey(sceneName))
//        {
//            bgmPlayer.clip = bgmClips[sceneName];
//            PlayBgm(true);
//        }
//        else
//        {
//            Debug.LogWarning($"Scene '{sceneName}'에 해당하는 BGM이 없습니다.");
//        }
//    }
